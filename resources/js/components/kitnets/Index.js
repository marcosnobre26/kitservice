          ...
          <table className="table">
            ...
            {kitnets.map(kitnet => (
              <tr key={kitnet.id}>
                ...
                <td>{kitnet.value}</td>
                <td>
                  <button className="badge badge-primary mr-2" onClick={()=>viewKitnet(kitnet.id)}>
                    Visualizar
                  </button>
                </td>
                <td>
                  <button className="badge badge-success" onClick={()=>editKitnet(kitnet.id)}>
                    Editar
                  </button>
                </td>
                <td>
                  <button className="badge badge-danger mr-2" onClick={()=>deleteKitnet(kitnet.id)}>
                    Deletar
                  </button>
                </td>
              </tr>
